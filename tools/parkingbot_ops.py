...
REQUIRED = (
    ...
    "REAR_MARKER_HEIGHT_M", "FRONT_MARKER_YAW_OFFSET_DEG",
    "REAR_MARKER_YAW_OFFSET_DEG", "WHEELBASE", "FRONT_SERIAL",
...
def conditional_config_errors(config: dict[str, str]) -> list[str]:
    ...
    if not 0.01 <= serial_write_timeout_value <= 0.10:
        errors.append("SERIAL_WRITE_TIMEOUT_S must be in [0.01, 0.10]")
    return errors
